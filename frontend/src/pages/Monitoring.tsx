  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-1 sm:gap-2 bg-card p-1 rounded-lg border shadow-sm self-end sm:self-auto">
          <Button 
      ...
      <Card className="h-[500px] sm:h-[600px] border-border/50 shadow-lg">
        ...
        <CardContent className="h-[400px] sm:h-[500px] pt-4">
          {isLoading ? (
